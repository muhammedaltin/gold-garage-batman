  ...
  head: () => ({
    meta: [
      ...
      { title: "Gold Garage | Boyasız Oto Göçük Düzeltme ve PPF Kaplama" },
      {
        name: "description",
        content:
          "Gold Garage Batman'de boyasız oto göçük düzeltme, PPF kaplama, cam film kaplama ve araç modifikasyon hizmetleri sunar. Maslak Oto Sanayi tecrübesi.",
      },
      { name: "author", content: "Gold Garage" },
      {
        property: "og:title",
